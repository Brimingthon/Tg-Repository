...
import org.project.handler.SceduleTask;
...
public class FindCommits extends UpdateHandler {
	...
	public void handle(UserPhase userPhase, Update update) throws TelegramApiException {
		...
		SceduleTask sceduleTask = new SceduleTask();
		sceduleTask.updateRepoInfo();

		sendRemovableMessage(userId, repoService.getInfoAboutCommit(repoId),
				getBackRepoKeyboard(repoId, REPO_DETAILS));
